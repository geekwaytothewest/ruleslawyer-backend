...
async function main() {
  ...
  const geekwayPrime2026 = await prisma.convention.upsert({
    where: {
      name_organizationId: {
        name: 'Geekway to the West 2026',
        organizationId: geekway.id,
      },
    },
    update: {
    ...
    create: {
      name: 'Geekway to the West 2026',
      organizationId: geekway.id,
      theme: 'Geekway to the Painbow',
      tteConventionId: '662377B8-BEBD-11F0-AE5C-E819A8A32801',
